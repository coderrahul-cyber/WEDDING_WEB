...
// const WhoAreWe = () => {
//   return (
//     <section id='whoweare' className="  relative min-h-screen max-h-screen w-full bg-bg px-6 py-10 text-[#422006] md:px-6 md:py-5">
...
const WhoAreWe = () => {
  ...
  return (
    <section
      id="whoweare"
      ref={container}
      className="relative min-h-screen max-h-screen w-full bg-bg px-6 py-10 text-[#422006] md:px-6 md:py-5 overflow-hidden"
    >
      <div className="flex flex-col justify-between h-full w-full min-h-[80vh]">
        {/* TOP SECTION */}
        <div className="flex flex-col items-start justify-between md:flex-row md:items-start">
